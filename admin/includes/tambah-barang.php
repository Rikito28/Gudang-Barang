<div class="container mt-5">
  ...
  <form action="proses/proses-tambah.php" method="POST" class="mt-3" autocomplete="off">
 ...
 <div class="form-group">
   ...
   <input type="text" name="kondisi" class="form-control" required placeholder="Baru/Bekas">
 </div>
      </div>
      <div class="col-md-4">
 <div class="form-group">
